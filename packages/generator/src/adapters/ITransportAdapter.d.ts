...
import { MethodDescriptor, CallOptions, ClientStreamingCall, BidiStreamingCall } from './types';
/**
 ...
 */
export declare function isTransportAdapter(obj: any): obj is ITransportAdapter;
//# sourceMappingURL=ITransportAdapter.d.ts.map