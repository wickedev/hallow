import { ATNDeserializer, toCharArray, VocabularyImpl, join, LexerATNSimulator, Lexer, NoViableAltException, RecognitionException, Token, ParserATNSimulator, Parser, ParserRuleContext, CharStreams, CommonTokenStream, AbstractParseTreeVisitor } from 'antlr4ts';
...
var ProtoLexer = /** @class */ (function (_super) {
    ...
    function ProtoLexer(input) {
        ...
        _this._interp = new LexerATNSimulator(ProtoLexer._ATN, _this);
        return _this;
    }
...
var ProtoParser = /** @class */ (function (_super) {
    ...
    function ProtoParser(input) {
        var _this = _super.call(this, input) || this;
        _this._interp = new ParserATNSimulator(ProtoParser._ATN, _this);
        return _this;
    }
...
function parse(proto) {
    var inputStream = CharStreams.fromString(proto);
