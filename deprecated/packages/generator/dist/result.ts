...
export class GreetingRequest extends jspb.Message {
    ...
    static toObject(includeInstance: boolean, message: GreetingRequest): IGreetingRequest & IObject {
        return {
            name: message.name,
            $messageInstance: includeInstance ? message : undefined,
        };
...
export class GreetingResponse extends jspb.Message {
    ...
    static toObject(includeInstance: boolean, message: GreetingResponse): IGreetingResponse & IObject {
        return {
